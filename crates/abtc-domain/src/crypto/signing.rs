...
use crate::hashing;
use crate::primitives::{Amount, Script, Transaction};
...
// NOTE: The `impl SignatureChecker for TransactionSignatureChecker` block
// lives in `script/checker_impl.rs` to avoid a `crypto → script` cycle.
